...
var (
	selectorMap = map[variableContentsKey]([]label){
		variableContentsKey{state: stateMainMenu, subStateIndex: stateMainMenuSelectorIndex, displayMode: displayMainMenu}: alignLabels(initRectangle(0.5, 0.0, 0.0, 1.0), xAlignCentre, yAlignCentre, initLocationlessLabel("New Game", termbox.ColorDefault, termbox.ColorBlack), initLocationlessLabel("Options", termbox.ColorDefault, termbox.ColorBlack), initLocationlessLabel("Exit", termbox.ColorDefault, termbox.ColorBlack)),
		variableContentsKey{state: statePausedGame, subStateIndex: statePausedGameSelectorIndex, displayMode: displayPause}: alignLabels(initRectangle(0.5, 0.2, 0.0, 0.8), xAlignCentre, yAlignCentre, initLocationlessLabel("Resume", termbox.ColorDefault, termbox.ColorBlack), initLocationlessLabel("Quit to Main Menu", termbox.ColorDefault, termbox.ColorBlack)),
	}
)
...
var (
	displayModeFunctions = [totalDisplayModes](func(rectangle)){
		func(border rectangle){},
		func(border rectangle){},
		func(border rectangle){},
		func(border rectangle){},
		func(border rectangle){},
